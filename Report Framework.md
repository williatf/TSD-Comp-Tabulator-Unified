...
Each report type (SoloAwardEntry, DuetAwardEntry, etc.) extends this base. This allows the UI to treat all report entries generically.
...
Create TrioAwardEntry

Create TrioAwardReportService

Create TrioAwardsLoaderAdapter

Create TrioAwardsScheme
